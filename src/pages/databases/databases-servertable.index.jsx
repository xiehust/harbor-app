...
import { API_NAME, COLUMN_DEFINITIONS, DEFAULT_PREFERENCES, Preferences } from './table-config';
...
export function TableContent({ 
  ...
  const [preferences, setPreferences] = useLocalStorage('React-Databases-Table-Preferences', DEFAULT_PREFERENCES);
