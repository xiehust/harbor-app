  ...
  return (
        ...
        <Header
          ...
          actions={
            ...
            (<SpaceBetween size="xs" direction="horizontal">
              <Button
                disabled={items.status === 'approved' || items.status === 'rejected' ||
                items.status === 'revoked'}
                variant="primary"
                onClick={() => {
                  setVisible(true);
                  setTriAction("approved");
                }}
              >
                {'Approve'}
              </Button>
    ...
    >
      ...
      <SpaceBetween size="l">
       ...
       {items.type !== "createdb" && permissions.tagsfilter? <LFTagsPanel data = {permissions.tagsfilter}/>:<div/>}
      </SpaceBetween>
    </ContentLayout>
  );
}
...
const ColumnsPermissionPanel = ({ datapermission,tagsfilter,table }) => {
  ...
  let dummy = tagsfilter ? tagsfilter.map(v => tagsfiltermap.set(v.column,'overwritten')):null;
...
export default function ApprovalDetail() {
  ...
  return (
    <CustomAppLayout
      ...
      breadcrumbs={<BreadcrumbsDynmic id={approvalId} />}
      content={
        details ? (
          <ContentPanel id={approvalId} items={details} isAdmin={isAdmin} />
        ) : (
          <Spinner size="large"/>
        )
      }
